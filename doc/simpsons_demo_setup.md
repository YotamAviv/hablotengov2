...
`demoSignIn` needs redeployment because `simpsons_keys.json` was regenerated in step 3.

### 5. Temporarily disable the demo write guard
...
### 7. Re-enable the demo write guard and redeploy
